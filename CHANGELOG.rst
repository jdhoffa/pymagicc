...
- (`#238 <https://github.com/openclimatedata/pymagicc/pull/238>`_) For MAGICC7, raise a DeprecationWarning instead of ValueError if multiple emissions scenarios are provided
